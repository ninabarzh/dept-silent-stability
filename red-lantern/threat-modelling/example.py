...
nav_layer = mapper.generate_attack_navigator_layer(
    scenarios, layer_name="BGP Hijacking Campaign Analysis"
)
...
# Analyse paths
p2_analysis = tree_gen.analyse_attack_paths(p2_tree)
p3_analysis = tree_gen.analyse_attack_paths(p3_tree)
...
gap_analyser.set_available_capabilities(
    ...
    detection_rules=["suspicious_login_detection", "bgp_announcement_monitor"],

...
class InfrastructureIOCExtractor:
    ...
    def _process_log_line(self, line: str):
        ...
        if 'login from' in line:
            ...
            if match:
                ...
                attack_context = f"Login as {account_match.group(1)}" if account_match else "Suspicious login"
    ...
    def _add_or_update_infrastructure(self, ip_address: str, infra_type: str,
                                      timestamp: datetime, attack_context: str,
                                      evidence: str):
